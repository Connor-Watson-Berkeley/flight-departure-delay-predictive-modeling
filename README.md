...
TODO(Paul): Draft a user guide on how to pull and usethe cross validation data for use in model development. Nothing too verbose, just code snippits is fine
